...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="http://localhost/doAn/danhmuc/main/styleDanhmuc.css" rel="stylesheet">
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<div class="container">
  <div class="row" >
    <div class="col-2">
      <a href="http://localhost/doan/index.html"> <img src="http://localhost/doan/Demo/images/Logo.png" width="180px" height="80px" alt=""></a>
    </div>
    <div class="col-10">
      <div class="row">
        <div class="col-6">
          ...
          <form class="form-inline  my-lg-0  "action="" method="POST">
                ...
                <!-- --------------------------------Tìm kiếm ------------------------------->
                <input class="form-control mr-sm-0 ml-5 "size="50   "name="tukhoa" type="search" placeholder=" Search something" aria-label="Tìm sản phẩm" >
        </div>
        <div class="mng-btn col-6">
          ...
          <button type="button"class="btn btn-dark">
            <a href="http://localhost/doan/account/tkKhachHang">INFO</a>
          </button>
          <button type="button"class="btn btn-dark">
            <a href="http://localhost/doAn/giohang/gioHang.php">CART</a>
          </button>
    ...
    <ul>
      <li><a href=""><span class="fa fa-laptop"></span>Laptop</a>
        <ul>
          ...
          <li><?php echo" <a href='http://localhost/doAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$dell '> <span class='fa fa-laptop'></span>Laptop Dell</a>"?></li>
          <li><?php echo" <a href='http://localhost/doAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$hp '> <span class='fa fa-laptop'></span>Laptop HP</a>"?></li>
          <li> <?php echo" <a href='http://localhost/doAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$acer '> <span class='fa fa-laptop'></span>Laptop Acer</a>"?>  </li>
          <li><?php echo" <a href='http://localhost/doAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$msi '> <span class='fa fa-laptop'></span>Laptop MSI</a>"?>   </li>
          <li><?php echo" <a href='http://localhost/doAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$asus '> <span class='fa fa-laptop'></span>Laptop Asus</a>"?></li>
        </ul>
      </li>
...
<div class="mySlides fade">
  <img src="http://localhost/doan/Demo/images/pcgamingslide1.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <img src="http://localhost/doan/Demo/images/keyboardgamingslide2.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <img src="http://localhost/doan/Demo/images/casegamingslide3.jpg" style="width:100%">
  <div class="text"></div>
</div>
...
<?php 
  ...
  <div class="col-12" style="color:white">
    ...
    if(isset($_POST['tukhoa'])) {
        $tukhoa = $_POST['tukhoa'];
        $timkiem = "SELECT * FROM sanpham WHERE tensp LIKE '%$tukhoa%'";
        $result_search = $conn->query($timkiem);
        $data_search = mysqli_fetch_all($result_search,MYSQLI_ASSOC);
        //  $stm = $conn->prepare($timkiem); 
        //  $stm->bind_param("s",$tukhoa);
        //  $tukhoa = $_POST['tukhoa'];
        //  $stm ->execute();
        ...
        <table class="table table-bordered" style="text-align: center;">
          ...
          <td class="product-data">
              <a href="chitietsp.php?action=them&id=<?php echo $value['masp'];?>"><img src="http://localhost/DoAn/sanpham/img/<?php echo $value['hinh'] ?> "style="max-width: 300px;"> </a>
