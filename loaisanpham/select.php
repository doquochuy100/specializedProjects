...
<body>
    ...
    <div class="container">
        ...
        while($row =mysqli_fetch_assoc($result) ){?>
            ...
            <?php 
                echo "<td> <a href='http://localhost/doAn/sanpham/themSP.php?id=".$row['maloai']."'> Thêm </a> </td>";

                echo "<td> <a href='http://localhost/DoAn/loaisanpham/edit.php?id=".$row['maloai']."'> Sửa </a> </td>";
            
                echo "<td> <a href='http://localhost/DoAn/loaisanpham/xulyXoa.php?id=".$row['maloai']."'> Xóa </a> </td>";
            ?>      
        </tr> 
