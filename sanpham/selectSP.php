...
<div class="container">
    <table border="1">
    <h3><a href="http://localhost/DoAn/sanpham/themSP2.php" style="text-decoration-none; color: red ">Thêm sản phẩm mới</a></h3>
    <tr>
        <td>ID LSP</td>
        <td>ID sản phẩm</td>
        <td> Tên sản phẩm </td>
    ...
    while($row =mysqli_fetch_assoc($result)){?>
        ...
        <?php 
            echo "<td> <a href='http://localhost/doAn/sanpham/editSP.php?id=".$row['masp']."'> Sửa </a> </td>";    
            echo "<td> <a href='http://localhost/doAn/sanpham/xuLyXoaSP.php?id=".$row['masp']."'> Xóa </a> </td>";
        ?>
