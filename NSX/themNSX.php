...
<body>
    ...
    <div class="container">
        <form action="http://localhost/doAn/NSX/xulyThemNSX.php" method="post">

        Mã nhà sản xuất:
        <input type="text" name="maNSX" class="form-control">
        Tên nhà sản xuất:
        <input type="text" name="tenNSX" class="form-control"> <br>
